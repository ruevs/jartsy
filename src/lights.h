...
public:
    ...
    virtual bool Intersect(Ray &r, Intersection *ints) const = 0;
};
...
public:
    ...
    inline bool Intersect(Ray &r, Intersection *ints) const override {
        ...
        r.tInt = std::max(r.tInt, CLOSEST_DISTANCE);
        return true;
...
public:
    ...
    bool Intersect(Ray &r, Intersection *ints) const override {
        // PAR@@@@@@@@ Presuming that the ray is the one generated by RayToLight!!!
